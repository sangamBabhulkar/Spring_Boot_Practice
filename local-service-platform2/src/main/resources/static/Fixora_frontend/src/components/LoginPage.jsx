...
const LoginPage = ({ navigate, role }) => {
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');

  const handleSubmit = (e) => {
    e.preventDefault();
    // Here, handle login logic (e.g., API request)
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-2xl sm:px-10 border border-gray-100">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                onClick={() => navigate(role === 'Partner' ? '/partner/register' : '/user/register')}
              ...
              >
                Create new {role.toLowerCase()} account
              </button>
            </div>
          </div>
        </div>
